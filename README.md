...
So i preparing and build demos about several service from AWS Cloud and share in talks with presentation.This is a list contain all talks. 
...
**Note**: all talks and/or post are in spanish language. Between 2022 - 2024 i was actived but i forget upload the content, so i have some but i don't have all. Sorry about it.
...
* **(Ecuador) AWS Community Day Ecuador 2026 | Evento Presencial - AWS Lambda en un Data pipeline: Lecciones aprendidas para armar una solución**: Lessons about how to use AWS Lambda to implement a data pipeline in transforming and ingestiong area.
  * Presentation: `2026/AWS Lambda en un Data pipeline.pdf` 
  * Publish Date: 05 September 2026
  * Language: Spanish
* **(Ecuador) AWS Community Day Ecuador 2026 | Evento Presencial - Defensa Contra las Artes Oscuras de
